            ...
            <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="mediummodalLabel" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form class="form" method="post" action="<?php echo base_url()?>index.php/Dashboard_g/simpan" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class='form-group'>
                                <label class="form-control-label">Kelas Murid</label>
                            ...
                            <div class='form-group'>
                                ...
                                <select class="form-control" name="guru" readonly>
                                <?php foreach ($c as $c) {?>
                            ...
                            <div class='form-group'>
                                ...
                                <select class="form-control" name="matpel" readonly>
                                <?php foreach ($d as $d) {?>
