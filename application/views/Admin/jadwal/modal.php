                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="admin/delete/<?php echo $a['NIK']?>"><button type="button" class="btn btn-primary">Hapus</button></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="mediummodalLabel" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form class="form" method="post" action="<?php echo base_url()?>index.php/admin/ubah/<?php echo $a['NIK']?>" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class='form-group'>
                                <label class="form-control-label">NIK</label>
