                                        ...
                                        <tbody>
                                          ...
                                          foreach ($a as $a) {
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn btn-outline-warning btn-sm" data-toggle="modal" id = "edit" data-target="#update" data-nis = "<?php echo $a['NIS']; ?>" data-nama = "<?php echo $a['Nama']; ?>" data-password = "<?php echo $a['Password']; ?>" data-kelas = "<?php echo $a['Kode_kelas']; ?>" data-alamat = "<?php echo $a['Alamat']; ?>" data-wali = "<?php echo $a['Wali']; ?>" data-foto = "<?php echo $a['Foto']; ?>"><i class="fa fa-pencil-square-o"></i></button>
